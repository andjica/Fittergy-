var app = new Framework7({
  ...
  routes: [
    ...
    {
      path: '/trener/',
      componentUrl: 'pages/trener.html',
    },
    {
      path: '/prepare_switch/',
      componentUrl: 'pages/prepareswitch.html',
    },
    {
      path: '/graphic1/',
      componentUrl: 'pages/graphic1.html',
    },
    {
      path: '/urin/',
      componentUrl: 'pages/urintest.html',
    },
    {
      path: '/index/',
